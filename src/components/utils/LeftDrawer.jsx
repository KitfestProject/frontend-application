...
const LeftDrawer = ({ isOpen, onClose, drawerWidth, children }) => {
  return (
    <Drawer
      open={isOpen}
      direction="left"
    ...
    >
      <div className="bg-white dark:bg-dark w-full h-full dark:border-r dark:border-gray/30 text-darken dark:text-slate-100 relative">
