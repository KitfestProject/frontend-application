...
const Modal = ({ onClose, children }) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-white dark:text-white dark:bg-primary w-[95%] md:w-[50%] h-auto fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-5 rounded-lg"
