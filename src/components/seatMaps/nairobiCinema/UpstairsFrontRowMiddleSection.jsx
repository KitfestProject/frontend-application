...
import { upstairsFrontMiddleSectionData } from "@/components/data/NairobiCinemaSeatData";
...
const UpstairsFrontRowMiddleSection = () => {
  ...
  return (
    <div className="flex flex-col gap-2 border-gray/50 rounded-lg p-5 relative items-center">
      {upstairsFrontMiddleSectionData.rows.map((row, rowIndex) => (
            ...
            <Seat
              ...
              onClick={() =>
                ...
                handleSeatClick({
                  ...
                  column: seat.column,
                  price: seat.price,
                  location: upstairsFrontMiddleSectionData.location,
                })
              }
            />
          ))}
