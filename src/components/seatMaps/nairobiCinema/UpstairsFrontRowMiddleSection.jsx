...
const UpstairsFrontRowMiddleSection = () => {
  ...
  const sectionSeats = eventSeatMap.upstairsFrontMiddleSection;
  ...
  const handleSeatClick = (seat) => {
    ...
    setEventSeatMap((prev) => {
      ...
      const updatedSection = { ...updatedSeatMap.upstairsFrontMiddleSection };
      ...
      updatedSeatMap.upstairsFrontMiddleSection = updatedSection;
