...
const UpstairsBackRowLeftSection = () => {
  ...
  const sectionSeats = eventSeatMap.upstairsBackLeftSection;
  ...
  const handleSeatClick = (seat) => {
    ...
    setEventSeatMap((prev) => {
      ...
      const updatedSection = { ...updatedSeatMap.upstairsBackLeftSection };
      ...
      updatedSeatMap.upstairsBackLeftSection = updatedSection;
