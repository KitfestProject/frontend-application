...
const CreateUpstairsFrontRowRightSection = () => {
  const [drawerOpen, setDrawerOpen] = useState(false);
  const { nairobiCinemaFormData } = useContext(CreateNairobiCinemaContext);
  const sectionData = nairobiCinemaFormData.upstairsFrontRightSection;
  ...
  return (
    <div className="flex flex-col justify-center items-center relative">
      ...
      <CreateTheaterSeatsDrawer
        ...
        sectionKey="upstairsFrontRightSection"
      />
    </div>
  );
};

export default CreateUpstairsFrontRowRightSection;
