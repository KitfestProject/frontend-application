...
const CreateDownStairsMiddleSection = () => {
  const [drawerOpen, setDrawerOpen] = useState(false);
  const { nairobiCinemaFormData, nairobiCinemaDataLoading } = useContext(
    CreateNairobiCinemaContext
  );
  const sectionData = nairobiCinemaFormData.downStairsMiddleSection;
  ...
  return (
    <div className="flex flex-col justify-center items-center relative">
      ...
      <CreateTheaterSeatsDrawer
        ...
        sectionKey="downStairsMiddleSection"
...
export default CreateDownStairsMiddleSection;
