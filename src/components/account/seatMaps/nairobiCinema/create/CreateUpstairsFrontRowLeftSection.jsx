...
const CreateUpstairsFrontRowLeftSection = () => {
  const [drawerOpen, setDrawerOpen] = useState(false);
  const { nairobiCinemaFormData } = useContext(CreateNairobiCinemaContext);
  const sectionData = nairobiCinemaFormData.upstairsFrontLeftSection;
  ...
  return (
    <div className="flex flex-col justify-center items-center relative">
      ...
      <CreateTheaterSeatsDrawer
        ...
        sectionKey="upstairsFrontLeftSection"
      />
    </div>
  );
};

export default CreateUpstairsFrontRowLeftSection;
