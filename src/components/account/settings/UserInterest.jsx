...
import { BiEdit, BiInfoCircle, BiPlus, BiTrash } from "react-icons/bi";
import { FaTriangleExclamation } from "react-icons/fa6";

const UserInterest = ({ data, interestData, setInterestData }) => {
          ...
          <div className="w-[700px] bg-white dark:bg-darkGray rounded-lg shadow-lg dark:border dark:border-gray/30">
            ...
            <div className="h-full max-h-[600px] overflow-y-scroll relative pb-10">
              <div className="p-5">
                ...
                <div className="mt-5 flex gap-2 items-center fixed bottom-0 left-0 w-full p-3 border-t border-gray/20 bg-white dark:bg-darkGray rounded-b-md">
                  <button
                    onClick={() =>
        ...
        <ModalAlert onClose={toggleShowShowAlertModal}>
          <div className="p-5">
            <div className="flex justify-center items-center p-3 rounded">
              <BiInfoCircle className="text-cyan-500 text-6xl" />
            </div>
