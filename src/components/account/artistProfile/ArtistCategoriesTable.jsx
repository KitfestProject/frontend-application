...
const ArtistCategoriesTable = () => {
  ...
  return (
    <>
      {/* Categories Table */}
      <div className="overflow-x-auto dark:bg-darkGray shadow-md rounded-md dark:border dark:border-gray/50 mt-5 mb-10">
        <table
          ref={tableRef}
          id="categories_table"
...
export default ArtistCategoriesTable;
