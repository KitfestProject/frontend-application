...
const AccountSidebarMenu = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center mb-5">
        <div className="flex flex-col gap-3 items-center justify-center mt-10">
          ...
          <img
            src={ProfileAvatar}
            alt="profile"
            className="w-[150px] h-[150px] rounded-full object-cover mt-5"
          />
          ...
          <div className="">
            ...
            <div className="flex gap-5 justify-between">
              ...
              <div className="flex gap-2 px-4 py-2 items-center bg-light dark:bg-dark rounded-md">
                <h4 className="text-sm text-primary dark:text-slate-100">10</h4>
              ...
              {/* Total Reviews */}
              <div className="flex gap-2 px-4 py-2 items-center bg-light dark:bg-dark rounded-md">
                <h4 className="text-sm text-primary dark:text-slate-100">5</h4>
                <p className="text-sm text-primary dark:text-slate-200">
                  Reviews
                </p>
              </div>
      ...
      {/* Profile Menu */}
      <div className="bg-[#F5F5F5] dark:bg-darkGray rounded-md dark:border dark:border-slate-700">
        {/* <button className="w-full py-3 flex gap-3 justify-center items-center rounded-t-md bg-primary text-white">
        ...
        <ul className="">
          ...
          <Link to="/my-wishlist">
            <li
              className={`flex items-center gap-3 ${
                location.pathname === "/my-wishlist" ? "account-nav-active" : ""
              } py-3 px-5 account-nav cursor-pointer`}
            >
              <span className="text-primary dark:text-slate-100">
