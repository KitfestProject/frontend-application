  ...
  return (
    <>
      <div className="p-5 bg-white dark:bg-darkGray h-[310px] max-w-[500px] w-full rounded-md dark:border dark:border-gray/30 shadow-md">
        {/* Warning Icon */}
        <div className="flex justify-center items-center bg-red-200/50 dark:bg-gray w-[100px] h-[100px] rounded-full mx-auto mb-5">
          <BiError className="text-red-600 dark:text-slate-100 text-[60px]" />
        </div>
...
export default EditEventDeleteWarning;
